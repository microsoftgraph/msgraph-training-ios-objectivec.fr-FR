# <a name="microsoft-graph-----objective-c--microsoft-graph-sdk--ios-"></a>Microsoft Graph 培训模块-使用 objective-C 和 le kit de développement logiciel (SDK) Microsoft Graph 生成 iOS 本机应用
